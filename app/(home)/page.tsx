...
export default function Home() {
	return (
		<PageContainer>
			...
			<Section title={ 'Skills' } href={ '/skills' } linkText={ 'Learn More' }
							 ...
							 image={ '/skills.png' } reverse={ true }/>
			<Section title={ 'Frameworks' } href={ '/frameworks' } linkText={ 'Learn More' }
							 ...
							 image={ '/frameworks.webp' } reverse={ false }/>
			<Section title={ 'What I\'m exploring' } href={ '/what-im-exploring' } linkText={ 'Learn More' }
							 ...
							 image={ '/what-i-am-exploring.png' } reverse={ true }/>
			<Section title={ 'My Code' } href={ '/my-code' } linkText={ 'Learn More' }
							 ...
							 image={ '/my-code.png' } reverse={ false }/>
		</PageContainer>
	);
}
